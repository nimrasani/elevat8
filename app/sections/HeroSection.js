    ...
    >
      ...
      <div className="relative z-10 lg:max-w-[1248px] mx-auto py-14 md:py-20 lg:py-40 lg:px-0 md:px-6 px-4">
        ...
        <p className="text-sm lg:text-base mb-7 text-[#B8B8B8] max-w-[550px]">
          Premium facilities, elite coaching and a training environment designed
          for people who expect more from themselves.
        </p>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <a
            ...
            bg-[#D7FF3F] hover:bg-[#D7FF3F]/90 focus:bg-[#D7FF3F]/90
            h-[44px] py-4 px-10 ease-in-out duration-300 transition-all"
          >
          ...
          <a
            ...
            bg-transparent hover:bg-[#1E1E1E]/90 hover:text-white/90
            focus:text-white/90 border border-[#B8B8B880]
            h-[44px] py-4 px-10 ease-in-out duration-300 transition-all"
          >
            Book A Club Tour
          </a>
